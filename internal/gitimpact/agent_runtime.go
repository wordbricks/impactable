...
func phaseInstructions(phase Phase) string {
	...
	case PhaseScore:
		return "Explore analytics schema through OneQuery, choose relevant metrics, query bounded before/after windows, calculate PR impact and contributor stats. Return scored_data and advance_phase."
	case PhaseReport:
